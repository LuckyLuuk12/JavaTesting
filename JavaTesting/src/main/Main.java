      ...
      if(input.toLowerCase().contains("help")) {
        System.out.print(
          """
            ...
            \u001B[33m 5. dg-set <number1> <number2> \u001B[37m| sets an edge from <number1> to <number2>
            \u001B[33m 6. dg-setlist <array>         \u001B[37m| sets edges from an array formatted [[0,1],[1,2],..]
            \u001B[33m 7. dg-show                    \u001B[37m| shows all specified data of the Directed Graph
            \u001B[33m 8. dg-size <number>           \u001B[37m| sets the amount of vertices AND resets the Graph
            \u001B[33m 9. dg-sink                    \u001B[37m| returns a vertex which is an Universal Sink
            \u001B[33m10. dg-idfs <number>           \u001B[37m| performs iterative DFS starting at <number>, starts at 0 if <number> is not given
            \u001B[33m11. dg-rdfs <number>           \u001B[37m| performs recursive DFS starting at <number>, starts at 0 if <number> is not given
            \u001B[33m12. dg-mother                  \u001B[37m| returns a mothervertex, if there is none it returns -1
            \u001B[33m13. dg-dijkstra                \u001B[37m| performs dijkstra if the graph is weighted
            \u001B[33m14. lfsr <bitstring> <number>  \u001B[37m| returns an LFSR'ed bitstring shifted <number> times
            \u001B[33m15. inc <bitstring>            \u001B[37m| increments the given <bitstring> by 1
            \u001B[33m16. findkey <outputStream>     \u001B[37m| performs exhaustive key search to find the original input of the <outputStream>
            \u001B[0m
            """);
      }
